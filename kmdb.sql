...
.print "======"
.print ""
SELECT title || '          ' || year_released || '           ' || mpaa_rating || '  ' || (SELECT name FROM Studios WHERE studio_id = Movies.studio_id)
FROM Movies;

-- Query for Cast Output
.print ""
.print "Top Cast"
.print "========"
.print ""
SELECT M.title || '          ' || A.name || '        ' || MA.character_name
FROM MovieActors MA
